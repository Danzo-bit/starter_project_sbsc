    ...
    try {
      ...
      if (result['isSuccess'] == true) {
        ...
        showFlushBar(
          context: context,
          success: true,
          message: 'Document saved to your device',
        );
      } else {
        //show error message
        showFlushBar(context: context, message: defaultErrorMessage,success: false);
      }
    } catch (e) {
      //show error message
      showFlushBar(context: context, message: e.toString(),success: false);
    }
  }
